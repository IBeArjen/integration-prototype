# -*- coding: utf-8 -*-
"""SDP Quality Assessment Service (RPyC flavour).
...
class QualityAssessmentService(rpyc.Service):
    """RPyC service for the Quality Assessment Service."""
    ...
    def exposed_health_check():
        ...
        return dict(module='Quality Assessment',
...
def main():
    ...
    server = ThreadedServer(QualityAssessmentService, port=12345)
    server.start()
